...
public class EndLevelTrigger extends Character {
	...
	public EndLevelTrigger(World world, String path, float x, float y) {
		super(world, x, y);
	    ...
	    shape.setAsBox(sprite.getWidth() / (4 * PIXELS_PER_METER),
		...
		entity.setUserData("ENDLEVELTRIGGER");
		shape.dispose();
		facingRight = false;
	}
	
	public EndLevelTrigger getEndLevel() {
		return this;
	}
