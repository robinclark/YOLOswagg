...
public class MapBodyManager {
	...
	public void createPhysics(TiledMap map, String layerName) {
		MapLayer layer = map.getLayers().get(layerName); //RC change from getlayer(String string)
		...
		while(objectIt.hasNext()) {
			...
			//String material = properties.getAsString("material", "default"); //RC
			/********************************************/
			Object value;
			String material;
